const NewNote = async ({ newCat, newtextareaValue }) => {
  // const token =
  ...
  console.log(newCat + "this is new cat!");
  var raw = JSON.stringify({
    data: {
      category: [newCat],
      Name: newtextareaValue,
  ...
  const response = await fetch(`${url}/api/notes/`, requestOptions);
  try {
